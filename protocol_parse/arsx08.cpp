...
#define ARS408
	...
	cout<<"CAN1_Obj_1_Msg.Obj_ID:"<<CAN1_Obj_1_Msg.Obj_ID<<endl;

    CAN1_Obj_1_Msg.Obj_LongDispl    = ((CANRxMsg->Data[1]<<5)|(CANRxMsg->Data[2]>>3))*0.2 - 500;
	cout<<"CAN1_Obj_1_Msg.Obj_LongDispl:"<<CAN1_Obj_1_Msg.Obj_LongDispl<<endl;

    CAN1_Obj_1_Msg.Obj_LatDispl     = ((((CANRxMsg->Data[2]&0x07)<<8)|(CANRxMsg->Data[3]>>0))*0.2)-204.6;
	cout<<"CAN1_Obj_1_Msg.Obj_LatDispl:"<<CAN1_Obj_1_Msg.Obj_LatDispl<<endl;

    CAN1_Obj_1_Msg.Obj_DynProp      = (CANRxMsg->Data[6]>>0)&0x07;
	cout<<"CAN1_Obj_1_Msg.Obj_DynProp:"<<CAN1_Obj_1_Msg.Obj_DynProp<<endl;

    CAN1_Obj_1_Msg.Obj_VerlLong     = (((CANRxMsg->Data[4]&0xFF)<<2)|(CANRxMsg->Data[5]>>6))*0.25 - 128;
	cout<<"CAN1_Obj_1_Msg.Obj_VerlLong:"<<CAN1_Obj_1_Msg.Obj_VerlLong<<endl;

    CAN1_Obj_1_Msg.Obj_VerlLat      = (((CANRxMsg->Data[5]&0x3F)<<3)| ((CANRxMsg->Data[6]&0xE0)>>5))*0.25-64;
	cout<<"CAN1_Obj_1_Msg.Obj_VerlLat:"<<CAN1_Obj_1_Msg.Obj_VerlLat<<endl;
#endif    
